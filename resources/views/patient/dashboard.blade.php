...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div class="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <a href="{{ route('patient.appointments.index') }}" class="mt-4 inline-block text-xs font-bold bg-white/20 hover:bg-white/30 px-3 py-1.5 rounded-lg transition-colors">History</a>
        </div>
        <div class="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <a href="{{ route('patient.appointments.create') }}" class="mt-4 inline-block text-xs font-bold bg-white/20 hover:bg-white/30 px-3 py-1.5 rounded-lg transition-colors">Book New</a>
        </div>
        <div class="bg-gradient-to-br from-green-500 to-green-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <a href="{{ route('patient.vitals.index') }}" class="mt-4 inline-block text-xs font-bold bg-white/20 hover:bg-white/30 px-3 py-1.5 rounded-lg transition-colors">Vitals Chart</a>
        </div>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center gap-4 p-4 border dark:border-gray-700 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <div class="shrink-0 text-center bg-primary-100 dark:bg-primary-900/40 p-2.5 rounded-xl min-w-[55px]">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-bold text-gray-900 dark:text-white truncate">Dr. {{ $appt->doctor->user->name }}</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="relative pl-6 border-l-2 border-gray-100 dark:border-gray-700">
                    ...
                    <p class="text-sm font-bold text-gray-900 dark:text-white">Dr. {{ $appt->doctor->user->name }}</p>
